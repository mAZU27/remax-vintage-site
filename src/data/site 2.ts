...
export const nav: NavItem[] = [
  ...
  { label: 'Alugar', href: '/insights#alugar' },
...
export const stats = [
  { value: '+12', label: 'anos de experiência', note: 'no mercado do Porto' },
  { value: '+650', label: 'imóveis', note: 'comercializados com sucesso' },
  { value: '+250M€', label: 'volume', note: 'de transações acumulado' },
  { value: '97%', label: 'clientes', note: 'que recomendam o serviço' },
] as const;
// NOTE(stats): valores ilustrativos — confirmar com a equipa antes do lançamento.
